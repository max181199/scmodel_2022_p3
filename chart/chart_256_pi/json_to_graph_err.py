...
for t in range(0, k + 1):
    if (t == 0 or t == 20 or t == k): 
        ...
        ax.set_title('Lx=Ly=Lz=3.14, N=' + str(size) + ', T=1, K=' + str(442) + ', t=' + str(t) + ', s=' + str(step), fontsize = 120)
